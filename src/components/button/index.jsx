...
const Button = ({
	...
	const baseStyles =
		"rounded-md text-sm font-medium px-4 py-2 focus:outline-none transition flex gap-2 flex gap-2 items-center justify-center min-h-[40px] disabled:opacity-60";
	...
	const colorStyles = {
		...
		white: {
			contained: "hover:bg-gray-200 text-gray-800 bg-gray-100",
			outlined:
				"border border-gray-300 text-white hover:bg-gray-50 hover:bg-opacity-15",
			text: "text-white hover:bg-white hover:bg-opacity-15",
		},
		black: {
			contained: "bg-background text-white hover:bg-background/90",
			outlined:
				"border border-background text-background hover:bg-background-50 hover:bg-opacity-15",
			text: "text-background hover:bg-background hover:bg-opacity-15",
		},
	};
